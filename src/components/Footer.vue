  ...
  <footer class="py-6 px-7 flex justify-center flex-wrap items-baseline">
    <el-header>
      <el-tooltip
          ...
          placement="top"
      >
        <el-button type="success" :icon="Coffee" circle @click="centerDialogVisible = true" />
      </el-tooltip>

      <el-dialog v-model="centerDialogVisible" title="请作者们喝咖啡：）" width="30%" center>
        <el-row :gutter="20">
          <el-col :span="12"><div class="grid-content ep-bg-purple" /><img src="@/assets/wx.png" alt="请作者喝咖啡：）"></el-col>
          <el-col :span="12"><div class="grid-content ep-bg-purple" /><img src="@/assets/zfb.png" alt="请作者喝咖啡：）"></el-col>
        </el-row>
        <div>
